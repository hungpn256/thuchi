      ...
      <CardContent className="relative px-8 pt-6 pb-8">
        <div className="mb-6 flex items-center justify-between">
          <div className="text-sm">
            <span className="text-muted-foreground mr-2">Chưa có tài khoản?</span>
            <Link
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Button
            type="submit"
            className="from-primary-600 to-primary-500 text-primary-50 shadow-primary-500/25 group/button dark:from-primary-600/90 dark:to-primary-500/90 relative w-full overflow-hidden bg-gradient-to-r font-medium shadow-lg transition-all duration-300 hover:bg-white/10 dark:shadow-none dark:hover:bg-white/10"
          ...
          <Button
            type="button"
            variant="outline"
            className="border-primary-100 dark:border-primary-800/50 dark:shadow-neumorphic-dark-sm group/google hover:bg-primary-50/50 dark:hover:bg-primary-900/30 relative w-full overflow-hidden shadow-[0_2px_10px_rgb(0,0,0,0.06)] transition-all duration-300"
