...
export function Sidebar({ isCollapsed: propIsCollapsed }: SidebarProps) {
  ...
  return (
    <div className="flex h-full flex-col" data-sidebar>
      <div
        className={cn('flex h-14 items-center border-b px-6', isCollapsed && 'justify-center px-0')}
      >
      ...
      {!isCollapsed && (
        <div className="border-t p-4">
          <div className="bg-sidebar-accent/50 rounded-md p-3 text-center text-sm">
