...
export default function LoginPage() {
  return (
    <div className="min-h-screen w-full flex relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-background via-background/95 to-primary/5 dark:from-gray-950 dark:via-gray-900 dark:to-primary-900/5 overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center p-12 relative animate-fade-right">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        <div className="w-full max-w-md space-y-8 animate-fade-up">
          ...
          <div className="text-center space-y-2">
            ...
            <a
              href="#"
              className="inline-block text-sm font-medium bg-gradient-to-r from-primary-600 to-primary-500 bg-clip-text text-transparent hover:from-primary-500 hover:to-primary-400 transition-all duration-300"
            >
              Đăng ký ngay
            </a>
          </div>
